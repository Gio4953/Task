    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminpanel.client')),
            ],
        ),
        migrations.CreateModel(
            name='FilterWord',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.CharField(blank=True, default='none', max_length=128, null=True)),
                ...
                ('screenshot_url', models.URLField(blank=True, max_length=90, null=True)),
                ('status', models.PositiveIntegerField(default=1)),
                ('found_word', models.CharField(blank=True, max_length=255, null=True)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminpanel.client')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminpanel.site')),
            ],
        ),
    ]
